...
@app_commands.describe(thing_to_say= "BROTHERS OF THE NORTHERN REGION! FOLLOW ME INTO BATTLE TO BREAK FATHER CALEB'S LEGS IRL! ...both of them")
async def say(interaction: discord.Interaction, thing_to_say: str):
    await interaction.response.send_message(f"{interaction.user.name} said: {thing_to_say}")

bot.run('MTExNjY5ODc1NjA0NjM4OTMwMA.Gnp7TP.pST_4OXEUQbxDuzfVuOFhiHpllNi0DC5BcQWM0')
